...
public final class Descriptors {
        ...
        final GenericDescriptor typeDescriptor =
            getFile()
                ...
                .lookupSymbol(
                    ...
                    this,
                    expectingEnum
                        ? FileDescriptorTables.SearchFilter.ENUMS_ONLY
  ...
  private static final class FileDescriptorTables {
    ...
    GenericDescriptor findSymbol(final String fullName, final SearchFilter filter) {
      ...
      if (result != null) {
        if ((filter == SearchFilter.ALL_SYMBOLS)
            ...
            || (filter == SearchFilter.ENUMS_ONLY && isEnum(result))
    ...
    /** Checks if the descriptor is an enum. */
    boolean isEnum(GenericDescriptor descriptor) {
    ...
    GenericDescriptor lookupSymbol(
      ...
      if (result == null) {
        if (allowUnknownDependencies
            && (filter == SearchFilter.TYPES_ONLY || filter == SearchFilter.ENUMS_ONLY)) {
          logger.warning(
          ...
          if (filter == SearchFilter.ENUMS_ONLY) {
